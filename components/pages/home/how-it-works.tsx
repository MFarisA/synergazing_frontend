export function HowItWorks() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-white to-slate-100 dark:from-gray-900 dark:to-black">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
            Cara Kerja Platform
          </h2>
          <p className="mt-4 text-gray-600 md:text-xl max-w-[600px] mx-auto dark:text-gray-300">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {/* Step 1 */}
          <div className="text-center backdrop-blur-md bg-white/30 dark:bg-white/10 border border-white/20 rounded-2xl shadow-lg p-6 transition-all hover:scale-105">
