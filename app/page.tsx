...
import { Users, Search, MessageCircle, Briefcase, GraduationCap, Target, Zap, ArrowRight, Calendar } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
        <Link href="/" className="flex items-center justify-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl">Synergizing.space</span>
          </div>
        </Link>
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl">
                  Temukan rekan kolaborasi yang tepat, bergabung dengan proyek menarik, atau rekrut talenta terbaik
                  untuk proyek Anda. Seperti LinkedIn bertemu Facebook Marketplace untuk mahasiswa.
                </p>
              </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Profil Komprehensif</CardTitle>
                  <CardDescription>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Eksplorasi Proyek</CardTitle>
                  <CardDescription>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Komunikasi Langsung</CardTitle>
                  <CardDescription>
        ...
        <section id="projects" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Proyek Terbaru</h2>
              <p className="mt-4 text-gray-600 md:text-xl max-w-[600px] mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Aplikasi Smart Campus IoT</CardTitle>
                  <CardDescription>
                    Mengembangkan sistem IoT untuk monitoring fasilitas kampus dengan dashboard real-time
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600">Synergize It!</Button>
                </CardContent>
              </Card>
                ...
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Desain Komunikasi Visual</p>
                    </div>
                  </div>
                  <CardTitle className="text-lg">Kampanye Sosial Lingkungan</CardTitle>
                  <CardDescription>
                    Merancang kampanye kreatif untuk meningkatkan kesadaran lingkungan di kalangan mahasiswa
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex flex-wrap gap-2 mb-4">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Riset AI untuk Kesehatan</CardTitle>
                  <CardDescription>
                    Penelitian pengembangan model AI untuk diagnosis dini penyakit berbasis data medis
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex flex-wrap gap-2 mb-4">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Cara Kerja Platform</h2>
              <p className="mt-4 text-gray-600 md:text-xl max-w-[600px] mx-auto">
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="text-center text-white">
              ...
              <p className="mx-auto max-w-[600px] text-blue-100 md:text-xl mb-8">
                Bergabunglah dengan ribuan mahasiswa yang sudah menemukan partner proyek ideal mereka
              </p>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-gray-50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">Synergizing.space</span>
        </div>
        <p className="text-xs text-gray-500 sm:ml-4">
          © 2024 Synergizing.space. Platform kolaborasi untuk mahasiswa Indonesia.
        </p>
